...
public class NewTestGMO {
	...
	public void beforeClass() throws Exception {
		browserSetup = new BrowserSetup(Browser.FIREFOX, false);
		wd = browserSetup.navigateToURL("https://demo.borland.com/gmopost/");
	}
	...
	private static void enterOrderQuantity() {
		...
		int randVal = (int) (Math.random() * NoOfQuantityFields) + 1;
